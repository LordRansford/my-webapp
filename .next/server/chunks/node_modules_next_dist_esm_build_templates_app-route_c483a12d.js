;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="8f8b7846-7b9d-6200-702b-9a99ee899459")}catch(e){}}();
module.exports=[555227,e=>{"use strict";var t=e.i(747909),r=e.i(174017),o=e.i(996250),n=e.i(759756),a=e.i(561916),i=e.i(114444),s=e.i(837092),l=e.i(869741),u=e.i(316795),c=e.i(487718),d=e.i(995169),h=e.i(47587),p=e.i(666012),f=e.i(570101),g=e.i(626937),m=e.i(10372),w=e.i(193695);e.i(52474);var y=e.i(600220),x=e.i(89171),b=e.i(657194),v=e.i(936426),R=e.i(895968);let E=["medical","doctor","diagnosis","legal","lawsuit","attorney","politics","election","crypto","stock"];var O=e.i(385725);let A=[{id:"cyber_game_trust_boundary",title:"Spot the trust boundary",route:"/cybersecurity/summary",tips:["Pick one real system you use daily","Mark where identity or trust changes","Write the first log you would want at that boundary"]},{id:"ai-summary-scenario-triage",title:"AI scenario triage",route:"/ai/summary",tips:["Name the real system (search, recommendations, moderation, automation)","List the quiet failure mode","Decide the smallest safe change"]}];var k=e.i(902157),T=e.i(750227);let $=new Set(["a","an","and","are","as","at","be","by","can","do","does","for","from","how","i","in","is","it","of","on","or","the","this","to","what","when","where","why","with","you","your"]);var C=e.i(666680);let S=null;function N(e,t){let r=C.default.createHash("sha256").update(e).digest(),o=new Float32Array(t);for(let e=0;e<t;e+=1)o[e]=r[e%r.length]/255*2-1;return Array.from(o)}async function I(e,t){let r=process.env.OPENAI_API_KEY||"";if(!r)return N(e,t);let o=await fetch("https://api.openai.com/v1/embeddings",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${r}`},body:JSON.stringify({input:e,model:"text-embedding-3-small"})});if(!o.ok)return N(e,t);let n=await o.json(),a=n?.data?.[0]?.embedding;return Array.isArray(a)?a.map(e=>Number(e)):N(e,t)}async function P(e,t,r=6){let o=function(){if(S)return S;let e=T.default.join(process.cwd(),"data","mentor","embeddings.json");if(!k.default.existsSync(e))throw Error("Missing data/mentor/embeddings.json. Run npm run build:mentor-embeddings.");return S=JSON.parse(k.default.readFileSync(e,"utf8"))}(),n=o.embeddingDim||128,a=await I(e.slice(0,8e3),n),i=String(e||"").toLowerCase().replace(/[^a-z0-9\s]/g," ").split(/\s+/).filter(Boolean),s=o.vectors.map(e=>{let t=function(e,t){let r=0,o=0,n=0,a=Math.min(e.length,t.length);for(let i=0;i<a;i+=1)r+=e[i]*t[i],o+=e[i]*e[i],n+=t[i]*t[i];return o&&n?r/Math.sqrt(o*n):0}(a,e.embedding),r=e.anchor?`${e.route}#${e.anchor}`:e.route,o=`Relevant ${e.kind} section${e.anchor?` (${e.anchor})`:""}`,n=`${e.title} ${r}`.toLowerCase(),s=i.filter(e=>n.includes(e)).length,l=.25*("tool"===e.kind);return{title:e.title,href:r,why:o,pageTitle:e.title,pageRoute:e.route,anchor:e.anchor,score:t+(s?.12+.08*s:0)+l,matchCount:s}});s.sort((e,t)=>t.score-e.score);let l=s.slice(0,r),u=l.some(e=>i.some(t=>e.href.toLowerCase().includes(t))),c=s.filter(e=>e.href.includes("/studios/")||"tool"===e.kind).sort((e,t)=>t.matchCount-e.matchCount||t.score-e.score)[0];if(!u){let e=s.find(e=>e.matchCount>0);e&&(l=[e,...l.filter(t=>t.href!==e.href)].slice(0,r))}c&&!l.find(e=>e.href===c.href)&&(l=[c,...l].slice(0,r));let d=0===l.length||l[0].score<.12;return{matches:l,weak:d}}async function L(e,t,r=8){let o=[];try{for(let n of(await P(e,t,r)).matches){let e=n.why||"";o.push({title:n.title||n.pageTitle||"Content",href:n.href,excerpt:e,text:e,why:n.why,kind:n.href.includes("/tools/")?"tool":n.href.includes("#")?"section":"page",score:n.score||0})}}catch(e){console.error("[MENTOR] Vector retrieval failed:",e)}for(let n of function(e,t,r=6){let o=String(e||"").toLowerCase().replace(/[^a-z0-9\s]/g," ").replace(/\s+/g," ").trim().split(" ").filter(Boolean).filter(e=>e.length>=2&&!$.has(e)).slice(0,15);if(!(o=function(e){let t=new Set(e);for(let r of e)("digitalisation"===r||"digitalization"===r)&&(t.add("digitalisation"),t.add("digitalization"),t.add("digital"),t.add("digitize"),t.add("digitise")),"digital"===r&&(t.add("digitalisation"),t.add("digitalization"));return Array.from(t)}(o)).length)return{matches:[],weak:!0};let n=function(){let e=T.default.join(process.cwd(),"public","content-index.json");if(!k.default.existsSync(e))throw Error("Missing public/content-index.json. Run npm run build:content-index.");return JSON.parse(k.default.readFileSync(e,"utf8"))}(),a=[];for(let e of n.pages){let r=t&&e.route===t?6:t&&e.route.startsWith(t.split("/")[1]||"")?1:0,n=e.title.toLowerCase(),i=0;for(let e of o)n.includes(e)&&(i+=3);for(let t of e.sections){if(!t.anchor)continue;let n=function(e,t,r){let o=t.title.toLowerCase(),n=(t.excerpt||"").toLowerCase(),a=`${o} ${n}`,i=0;for(let t of e){if(!t)continue;o===t||o.includes(` ${t} `)||o.startsWith(`${t} `)||o.endsWith(` ${t}`)?i+=8:o.includes(t)&&(i+=5);let e=RegExp(`\\b${t}\\b`,"gi"),r=a.match(e);if(r&&(i+=1.5*r.length),t.length>=4){let e=RegExp(t,"gi"),o=a.match(e);o&&o.length>(r?.length||0)&&(i+=(o.length-(r?.length||0))*.5)}}return Math.round(i+r)}(o,t,r+i);n<=0||a.push({title:t.title,href:`${e.route}#${t.anchor}`,why:t.excerpt?t.excerpt.slice(0,200):"Relevant section in the notes.",pageTitle:e.title,pageRoute:e.route,anchor:t.anchor,score:n})}i>=3&&!a.some(t=>t.pageRoute===e.route)&&a.push({title:e.title,href:e.route,why:`Page about ${e.title}`,pageTitle:e.title,pageRoute:e.route,anchor:"",score:i})}a.sort((e,t)=>t.score-e.score);let i=a.slice(0,r),s=0===i.length||i[0].score<2;return{matches:i,weak:s}}(e,t,r).matches)if(!o.some(e=>e.href===n.href)){let e=n.why||"";o.push({title:n.title,href:n.href,excerpt:e,text:e,why:n.why,kind:n.href.includes("#")?"section":"course",score:n.score||.5})}if(["tool","how to use","how do i","tutorial","guide","playground","lab","workshop"].some(t=>e.toLowerCase().includes(t))||e.toLowerCase().includes("use"))for(let t of function(e,t=3){let r=function(){let e=T.default.join(process.cwd(),"public","tools-index.json");if(!k.default.existsSync(e))return null;try{let t=k.default.readFileSync(e,"utf8");return JSON.parse(t)}catch{return null}}();if(!r||!Array.isArray(r.tools))return[];let o=e.toLowerCase().replace(/[^a-z0-9\s]/g," ").split(/\s+/).filter(e=>e.length>=2).slice(0,12);return o.some(e=>e.includes("digital"))&&o.push("digitalisation","digitalization","digital"),r.tools.map(e=>{let t=String(e.title||"").toLowerCase(),r=String(e.description||"").toLowerCase(),n=String(e.explain||"").toLowerCase(),a=`${t} ${r} ${n}`,i=0;for(let e of o){t.includes(e)&&(i+=5),r.includes(e)&&(i+=2),n.includes(e)&&(i+=3);let o=a.match(RegExp(`\\b${e}\\b`,"g"));o&&(i+=o.length)}if(i<=0)return null;let s=e.explain||e.description||`Tool: ${e.title}`,l=e.route||`/tools/${e.id}`;return{title:e.title||"Tool",href:l,excerpt:s.slice(0,300),text:`${e.description||""}
