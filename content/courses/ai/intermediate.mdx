...
<Callout variant="info">
  **Recommended reading**: Before diving into intermediate concepts, consider reading [AI Fundamentals Explained](/posts/ai-fundamentals-explained) for a clear overview of data, models, evaluation, and deployment from first principles.
</Callout>
