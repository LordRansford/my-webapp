...
<SectionHeader variant="content" emoji="🔐" id="practice-p0-crypto-in-practice">
  Module P0. Crypto in practice
</SectionHeader>

<SectionProgressToggle courseId="cybersecurity" levelId="practice" sectionId="practice-p0-crypto-in-practice" />
...
<QuizBlock
  id="practice-p0-crypto-in-practice"
  courseId="cybersecurity"
  levelId="practice"
  sectionId="practice-p0-crypto-in-practice"
...
<SectionHeader variant="content" emoji="🏗️" id="practice-p1-secure-architecture-zero-trust">
  Module P1. Secure architecture and zero trust
</SectionHeader>

<SectionProgressToggle courseId="cybersecurity" levelId="practice" sectionId="practice-p1-secure-architecture-zero-trust" />
...
<QuizBlock
  id="practice-p1-secure-architecture-zero-trust"
  courseId="cybersecurity"
  levelId="practice"
  sectionId="practice-p1-secure-architecture-zero-trust"
...
<SectionHeader variant="content" emoji="🔍" id="practice-p2-detection-and-incident-response">
  Module P2. Detection and incident response
</SectionHeader>

<SectionProgressToggle courseId="cybersecurity" levelId="practice" sectionId="practice-p2-detection-and-incident-response" />
...
<QuizBlock
  id="practice-p2-detection-and-incident-response"
  courseId="cybersecurity"
  levelId="practice"
  sectionId="practice-p2-detection-and-incident-response"
...
<SectionHeader variant="content" emoji="📦" id="practice-p3-supply-chain-risk">
  Module P3. Supply chain risk
</SectionHeader>

<SectionProgressToggle courseId="cybersecurity" levelId="practice" sectionId="practice-p3-supply-chain-risk" />
...
<QuizBlock
  id="practice-p3-supply-chain-risk"
  courseId="cybersecurity"
  levelId="practice"
  sectionId="practice-p3-supply-chain-risk"
...
<SectionHeader variant="content" emoji="⚖️" id="practice-p4-adversarial-tradeoffs">
  Module P4. Adversarial trade offs
</SectionHeader>

<SectionProgressToggle courseId="cybersecurity" levelId="practice" sectionId="practice-p4-adversarial-tradeoffs" />
...
<QuizBlock
  id="practice-p4-adversarial-tradeoffs"
  courseId="cybersecurity"
  levelId="practice"
  sectionId="practice-p4-adversarial-tradeoffs"
  title="Quick check. Adversarial trade offs and failure analysis"
  questions={[
...
<SectionHeader variant="content" emoji="📋" id="practice-p5-governance-and-professional-practice">
  Module P5. Governance and professional practice
</SectionHeader>

<SectionProgressToggle courseId="cybersecurity" levelId="practice" sectionId="practice-p5-governance-and-professional-practice" />
...
<QuizBlock
  id="practice-p5-governance-and-professional-practice"
  courseId="cybersecurity"
  levelId="practice"
  sectionId="practice-p5-governance-and-professional-practice"
...
<SectionHeader variant="content" emoji="🏆" id="practice-p6-capstone">
  Module P6. Capstone
</SectionHeader>

<SectionProgressToggle courseId="cybersecurity" levelId="practice" sectionId="practice-p6-capstone" />
...
<QuizBlock
  id="practice-p6-capstone"
  courseId="cybersecurity"
  levelId="practice"
  sectionId="practice-p6-capstone"
