...
<SectionHeader variant="content" emoji="🧩" id="practice-p1-secure-sdlc">
...
<SectionHeader variant="content" emoji="🔐" id="practice-p3-runtime-and-cloud-security">
...
<SectionHeader variant="content" emoji="🏗️" id="practice-p2-exposure-reduction-zero-trust">
...
<SectionHeader variant="content" emoji="🧯" id="practice-p5-vulnerability-management">
...
<SectionHeader variant="content" emoji="🔍" id="practice-p6-detection-and-incident-response">
...
<SectionHeader variant="content" emoji="📦" id="practice-p4-supply-chain-security">
...
<SectionHeader variant="content" emoji="⚖️" id="practice-p8-system-ilities">
...
<SectionHeader variant="content" emoji="📋" id="practice-p7-privacy-ethics-auditability">
...
<SectionHeader variant="content" emoji="🏆" id="practice-p9-capstone-professional-practice">
