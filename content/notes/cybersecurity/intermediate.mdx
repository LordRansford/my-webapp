...
<LevelProgressBar courseId="cybersecurity" levelId="applied" sectionIds={cyberSectionManifest.applied} />
...
<DiagramBlock
  ...
  description="People and data cross boundaries; assumptions must be explicit."
>
...
<DiagramBlock
  ...
  description="A simple web app and the inputs that expand attack surface."
>
  <div className="text-xs sm:text-sm leading-5 space-y-2">
...
<DiagramBlock
  ...
  description="Login creates a session token that rides with each request."
>
  <div className="text-xs sm:text-sm leading-5 space-y-2">
...
<DiagramBlock
  ...
  description="Systems emit logs, you filter for signal, then alert a human or playbook."
>
  <div className="text-xs sm:text-sm leading-5 space-y-2">
