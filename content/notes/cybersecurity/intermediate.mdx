...
<CPDTracker courseId="cybersecurity" levelId="applied" estimatedHours={16} />
...
<SectionHeader variant="content" emoji="🎯" id="applied-a1-threat-modelling-as-design">
  Module A1. Threat modelling as design
</SectionHeader>

<SectionProgressToggle courseId="cybersecurity" levelId="applied" sectionId="applied-a1-threat-modelling-as-design" />
...
<QuizBlock
  id="applied-a1-threat-modelling-as-design"
  courseId="cybersecurity"
  levelId="applied"
  sectionId="applied-a1-threat-modelling-as-design"
...
<SectionHeader variant="content" emoji="🔍" id="applied-a3-web-app-security">
  Module A3. Web security in practice
</SectionHeader>

<SectionProgressToggle courseId="cybersecurity" levelId="applied" sectionId="applied-a3-web-app-security" />
...
<QuizBlock
  id="applied-a3-web-app-security"
  courseId="cybersecurity"
  levelId="applied"
  sectionId="applied-a3-web-app-security"
...
<SectionHeader variant="content" emoji="🔐" id="applied-a2-identity-and-access-control">
  Module A2. Identity and access control
</SectionHeader>

<SectionProgressToggle courseId="cybersecurity" levelId="applied" sectionId="applied-a2-identity-and-access-control" />
...
<QuizBlock
  id="applied-a2-identity-and-access-control"
  courseId="cybersecurity"
  levelId="applied"
  sectionId="applied-a2-identity-and-access-control"
  title="Quick check. Identity and sessions"
  questions={[
...
<SectionHeader variant="content" emoji="📊" id="applied-a6-logging-and-detection-basics">
  Module A6. Logging and detection basics
</SectionHeader>

<SectionProgressToggle courseId="cybersecurity" levelId="applied" sectionId="applied-a6-logging-and-detection-basics" />
...
<QuizBlock
  id="applied-a6-logging-and-detection-basics"
  courseId="cybersecurity"
  levelId="applied"
  sectionId="applied-a6-logging-and-detection-basics"
...
<SectionHeader variant="content" emoji="🧪" id="applied-a5-verification-and-release-gates">
  Module A5. Verification and release gates
</SectionHeader>

<SectionProgressToggle courseId="cybersecurity" levelId="applied" sectionId="applied-a5-verification-and-release-gates" />
...
<QuizBlock
  id="applied-a5-verification-and-release-gates"
  courseId="cybersecurity"
  levelId="applied"
  sectionId="applied-a5-verification-and-release-gates"
  title="Quick check. Verification"
  questions={[
    { q: "What is verification in security", a: "Checking that controls work as intended and fail safely under real conditions." },
    { q: "Why is verification important", a: "It prevents security theatre and catches broken assumptions before incidents." },
    { q: "What is one sign a control is weak", a: "It exists in the UI but not on the server, or it has no monitoring." },
  ]}
/>

<SectionHeader variant="content" emoji="🔌" id="applied-a4-api-and-service-security">
  Module A4. API and service security
</SectionHeader>

<SectionProgressToggle courseId="cybersecurity" levelId="applied" sectionId="applied-a4-api-and-service-security" />
...
<QuizBlock
  id="applied-a4-api-and-service-security"
  courseId="cybersecurity"
  levelId="applied"
  sectionId="applied-a4-api-and-service-security"
  title="Quick check. APIs"
  questions={[
    { q: "Why are APIs high impact", a: "They expose powerful actions between systems, often without a human in the loop." },
    { q: "What is one safe default for APIs", a: "Least privilege scopes and strong authorisation checks for each action." },
    { q: "Why do rate limits matter", a: "They reduce abuse and reduce damage during automated attacks." },
  ]}
/>

<SectionHeader variant="content" emoji="🏁" id="applied-a7-applied-capstone">
  Module A7. Applied capstone
</SectionHeader>

<SectionProgressToggle courseId="cybersecurity" levelId="applied" sectionId="applied-a7-applied-capstone" />
...
<ToolCard
  id="feature-security-review-pack"
  title="Build a feature security review pack"
  description="Capture threats, controls, verification, and evidence in one practical pack."
>
  <FeatureSecurityReviewPackTool />
</ToolCard>

<QuizBlock
  id="applied-a7-applied-capstone"
  courseId="cybersecurity"
  levelId="applied"
  sectionId="applied-a7-applied-capstone"
  title="Quick check. Capstone"
  questions={[
    { q: "What is the point of the capstone", a: "Show you can connect threat modelling, controls, and verification in one small review." },
    { q: "What should your controls include", a: "At least one preventive control and one detective control." },
    { q: "What makes a capstone defensible", a: "Clear scope, clear trade offs, and clear verification steps." },
  ]}
/>
