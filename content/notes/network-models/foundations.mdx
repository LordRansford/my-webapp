...
<SectionHeader variant="content" emoji="🧭" id="net-foundations-why-models-exist">
  Why models exist
</SectionHeader>
...
<SectionHeader variant="content" emoji="🧩" id="net-foundations-encapsulation-and-pdus">
...
<SectionHeader variant="content" emoji="🗺️" id="net-foundations-osi-and-tcpip-mapping">
...
<SectionHeader variant="content" emoji="🔎" id="net-foundations-addressing-and-names">
  Addresses and names
</SectionHeader>
...
<SectionHeader variant="content" emoji="🌍" id="net-foundations-requests-from-browser-to-server">
...
<DiagramBlock title="A plain flow you can memorise" subtitle="When you know the order, you stop guessing.">
  <div className="text-xs sm:text-sm leading-5 space-y-2">
    <div>DNS lookup → TCP connect → TLS handshake → HTTP request → HTTP response</div>
...
<SectionHeader variant="content" emoji="✅" id="net-foundations-foundations-capstone">
