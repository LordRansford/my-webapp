...
<ToolCard title="BookTrack safety drill" description="Stress test one decision from this capstone.">
  <ul>
    <li>Pick one decision you wrote (e.g., auth flow or data log policy).</li>
    <li>Describe one failure mode and one control that limits blast radius.</li>
  </ul>
</ToolCard>
