      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-slate-700 mb-4">
            {section 
              ? `Now that you understand ${section}, try building it yourself in the Live Studio.`
              : "Put your knowledge into practice. Create real AI models, train them, and deploy to production."
            }
          </p>
          <Link
            href="/ai-studio"
