...
export default function StepSystem({ audience = "students", systemName, systemDescription, onChange, errors = [] }) {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h2 className="text-xl font-semibold text-slate-900">System basics 🧱</h2>
        <p className="mt-1 text-sm text-slate-700">Name the system and describe what it is for.</p>
      </div>
