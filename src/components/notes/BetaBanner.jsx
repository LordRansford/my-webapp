    ...
    >
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0">
          <p className="m-0 text-sm font-semibold text-slate-900">Preview release</p>
          <div className="mt-2 space-y-1 text-sm text-slate-700">
            <p className="m-0">This site is in early release for feedback.</p>
            <p className="m-0">It is not accredited or certified yet.</p>
            <p className="m-0">
              Tools are for learning and demonstration only. Verify important decisions with authoritative sources.
            </p>
            <p className="m-0">
              No account is required. Progress is stored locally on this device for now.{" "}
              <Link
                href="/feedback"
