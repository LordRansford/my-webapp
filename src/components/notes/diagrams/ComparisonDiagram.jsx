  ...
  return (
    <DiagramFrame title={title} ariaLabel={title} reducedMotion={reducedMotion}>
      <svg viewBox="0 0 360 160" className="w-full h-auto" role="img" aria-label={title}>
        ...
        <text x="95" y="65" textAnchor="middle" className="text-[12px] fill-gray-800">
          {left?.label}
        </text>
        <text x="95" y="95" textAnchor="middle" className="text-[11px] fill-gray-600">
          {left?.detail}
        </text>
        <text x="265" y="65" textAnchor="middle" className="text-[12px] fill-gray-800">
          {right?.label}
        </text>
        <text x="265" y="95" textAnchor="middle" className="text-[11px] fill-gray-600">
          {right?.detail}
        </text>
