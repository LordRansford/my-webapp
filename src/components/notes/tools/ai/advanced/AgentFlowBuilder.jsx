    ...
    <div className="rounded-2xl border border-slate-200 bg-white/90 p-4 shadow-sm">
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-2">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-3 text-xs text-slate-700">
          ...
          <div className="mt-4 grid gap-2">
            <label className="text-sm font-semibold text-slate-800">Memory</label>
            <select
              value={memory}
      ...
      <div className="mt-4 grid gap-3 sm:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
        ...
        <div className="rounded-2xl border border-slate-200 bg-slate-50/70 p-3 text-sm text-slate-700">
          ...
          <div className="mt-3 rounded-xl border border-emerald-200 bg-emerald-50 p-2 text-sm text-emerald-800">
