...
const pairs = [
  {
    ...
    description: "Protecting information from people who should not see it",
    explain: "Confidentiality is keeping data hidden from unauthorised access.",
  },
  {
    id: "integrity",
    term: "integrity",
    description: "Making sure information is not changed by accident or on purpose",
    explain: "Integrity ensures data is accurate and unaltered.",
  },
  {
    id: "availability",
    term: "availability",
    description: "Keeping services working when people rely on them",
    explain: "Availability is about systems being up and usable when needed.",
  },
  {
    id: "threat-modelling",
    term: "threat modelling",
    description: "Thinking about what could go wrong before building a system",
    explain: "Threat modelling surfaces likely attacks and weaknesses early.",
  },
];
