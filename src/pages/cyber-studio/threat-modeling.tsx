        ...
        <div className="mx-auto max-w-7xl px-4 py-6 sm:py-8 sm:px-6 lg:px-8">
          ...
          <div className="rounded-3xl bg-white border border-slate-200 p-8 shadow-sm">
            ...
            <div className="text-center py-12">
              ...
              <h2 className="text-2xl font-semibold text-slate-900 mb-2">Threat Model Generator</h2>
              <p className="text-slate-600 mb-6 max-w-2xl mx-auto">This tool is currently under development.</p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/cyber-studio" className="px-6 py-3 bg-rose-600 hover:bg-rose-700 text-white rounded-lg font-semibold transition-colors">Back to Cyber Studio</Link>
