        ...
        <div className="mx-auto max-w-7xl px-4 py-6 sm:py-8 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-base sm:text-lg text-slate-600 mt-1">Generate policies from templates</p>
                </div>
              </div>
          ...
          <div className="rounded-3xl bg-white border border-slate-200 p-8 shadow-sm">
            <div className="text-center py-12">
              ...
              <h2 className="text-2xl font-semibold text-slate-900 mb-2">Security Policy Generator</h2>
              <p className="text-slate-600 mb-6 max-w-2xl mx-auto">This tool is currently under development.</p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/cyber-studio" className="px-6 py-3 bg-slate-600 hover:bg-slate-700 text-white rounded-lg font-semibold transition-colors">Back to Cyber Studio</Link>
