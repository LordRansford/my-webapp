                ...
                <HelpTooltip
                  ...
                  content={
                    <div className="space-y-4">
                      <p>
                        The Security Scanner scans your code to find security problems before attackers 
                        can exploit them. It is like having a security guard check your house for unlocked doors.
                      </p>
                      <div>
          ...
          <div className="rounded-3xl bg-white border border-slate-200 p-8 shadow-sm">
            ...
            <div className="text-center py-12">
              ...
              <p className="text-slate-600 mb-6 max-w-2xl mx-auto">
                This tool is currently under development. It will allow you to scan your code for 
                security vulnerabilities and validate security best practices.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  href="/dev-studio"
                  className="px-6 py-3 bg-rose-600 hover:bg-rose-700 text-white rounded-lg font-semibold transition-colors"
                >
                  Back to Dev Studio
                </Link>
                <Link
