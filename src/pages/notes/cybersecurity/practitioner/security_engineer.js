...
export default function Page({ source, headings }) {
  ...
  return (
    <NotesLayout meta={{ title: "Practitioner - Security Engineer", description: "Role based notes", level: "Practitioner" }} headings={headings}>
...
export async function getStaticProps() {
  const note = await loadNote("cybersecurity/practitioner/security_engineer.mdx");
  return {
    props: {
      source: note.source,
