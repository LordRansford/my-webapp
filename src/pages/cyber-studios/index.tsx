...
export default function CyberStudiosPage() {
  ...
  return (
    <div className="page-content max-w-6xl mx-auto space-y-8">
      <header className="rounded-3xl bg-gradient-to-br from-slate-50 via-rose-50/60 to-slate-50 ring-1 ring-slate-100 px-6 py-6 sm:px-8 sm:py-7 shadow-[0_18px_45px_rgba(15,23,42,0.06)] space-y-3">
        <div className="inline-flex items-center gap-2 rounded-2xl bg-slate-900 text-white px-3 py-1 text-xs font-semibold">
          Studio
          <span aria-hidden="true">•</span> Cybersecurity
        </div>
        <h1 className="text-3xl font-semibold text-slate-900">Cybersecurity Studio</h1>
