...
import StandaloneGamesHubClient from "./StandaloneGamesHub.client";

export const metadata: Metadata = {
  title: "Standalone Games Hub | Ransford's Notes",
  description: "Standalone games and puzzles (20 curated entries) with no course dependencies.",
  keywords: ["games", "strategy games", "puzzle games", "educational games", "multiplayer games", "offline games", "browser games"],
  openGraph: {
    title: "Standalone Games Hub | Ransford's Notes",
    description: "A curated set of standalone games for learning, strategy, and skill development.",
    type: "website",
    url: "/games/hub",
  },
  twitter: {
