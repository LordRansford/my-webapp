...
export default function DigitalisationTemplatesClient({ templates, areas }) {
  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-12 md:px-6 lg:px-8">
      <section className="space-y-4 rounded-3xl border border-slate-200 bg-white/90 p-8 shadow-sm backdrop-blur">
        <p className="text-sm font-semibold uppercase tracking-wide text-slate-600">Templates - Digitalisation</p>
        <h1 className="text-4xl font-semibold leading-tight text-slate-900">Digitalisation useful tools</h1>
        <p className="max-w-3xl text-base text-slate-700">
          Strategy, governance, delivery, and benefits tooling for digital programmes. Built for safe, quick planning and export.
        </p>
      ...
      <section className="mt-10 space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <h2 className="text-2xl font-semibold text-slate-900">Digitalisation tools</h2>
