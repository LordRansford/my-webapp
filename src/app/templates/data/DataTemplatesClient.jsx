...
export default function DataTemplatesClient({ templates, areas }) {
  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-12 md:px-6 lg:px-8">
      <section className="space-y-4 rounded-3xl border border-slate-200 bg-white/90 p-8 shadow-sm backdrop-blur">
        <p className="text-sm font-semibold uppercase tracking-wide text-slate-600">Templates - Data</p>
        <h1 className="text-4xl font-semibold leading-tight text-slate-900">Data useful tools</h1>
        <p className="max-w-3xl text-base text-slate-700">
          Practical data quality, governance, and interoperability tools. Built for fast checks and sharable exports.
        </p>
        <div className="rounded-2xl bg-slate-50 p-4 text-sm text-slate-800">
          Clear instructions, editable workspace, outputs, and attribution. Educational and planning aids, not legal advice; use
          only on data you are permitted to work on.
        </div>
      </section>

      <section className="mt-10 space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <h2 className="text-2xl font-semibold text-slate-900">Data tools</h2>
