...
import { courseSkillMappings, findSponsorLink } from "@/data/employers";
...
type Props = {
  token: string;
  resolved: ReturnType<typeof findSponsorLink>;
};

export default function SponsorAccessClient({ token, resolved }: Props) {
