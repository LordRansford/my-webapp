...
export const ROLE_PERMISSIONS: RolePermissions = {
  ...
  SUPPORT: ["VIEW_USERS", "VIEW_SUPPORT", "MANAGE_SUPPORT", "VIEW_ASSESSMENTS", "VIEW_SYSTEM"],
  READ_ONLY: ["VIEW_USERS", "VIEW_SUPPORT", "VIEW_ASSESSMENTS", "VIEW_BILLING", "VIEW_SYSTEM"],
} as const;
